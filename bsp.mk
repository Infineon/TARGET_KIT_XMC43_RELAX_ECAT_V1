...
#
# \brief
# Define the KIT_XMC43_RELAX_ECAT_V1 target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC4300-F100x256
DEVICE:=XMC4300-F100x256
DEVICE_COMPONENTS:=CAT3 XMC43XX
DEVICE_LIST:=XMC4300-F100x256
DEVICE_TOOL_IDS:=bsp-assistant device-configurator library-manager project-creator
DEVICE_XMC4300-F100x256_CORES:=CORE_NAME_CM4_0
DEVICE_XMC4300-F100x256_DIE:=XMC4300
DEVICE_XMC4300-F100x256_FLASH_KB:=256
DEVICE_XMC4300-F100x256_SRAM_KB:=128
